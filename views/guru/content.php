                    ...
                    <a class="nav-link pr-0" href="" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body ml-2 d-none d-lg-block">
                                ...
                                if ($baris == 0) {
                                ?>
                                    <span class="mb-0 text-sm  font-weight-bold">Selamat Datang, Dosen </span>
                                <?php } else { ?>
                                    <span class="mb-0 text-sm  font-weight-bold">*Selamat Datang, Dosen </span>
                                <?php } ?>
                            </div>
            ...
            <div class="col-md-12 ml-4">
                <form action="<?= base_url('guru') ?>" method="POST">
                    <div class="form-group">
                        <h3 style="text-transform: uppercase; border-bottom: 2px solid #fff; width: 50%; color: white; margin-bottom: 5%;">Monitoring mahasiswa</h3>
                        <div class="row">
                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <?php endforeach; ?>
                            <h3 class="mb-0">Daftar Bimbingan Mahasiswa KP</h3>
                        </div>
