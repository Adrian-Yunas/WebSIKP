...
<body>
	...
	<div class="kotak">
		<div class="col-satu">
			<img src="<?= base_url('assets/img/ukdw.png') ?>" alt="Foto Kampus" id="foto-kampus" class="animated infinite flip slow">
		</div>
		<form action="<?php echo base_url('login/CekLogin') ?>" method="POST">
			<div class="col-dua">
				...
				<div class="row">
					<div class="col-1"></div>
					<div class="col-10">
						<a class="big" href="<?= base_url('login/registration'); ?>">Create an Account!</a>
					</div>
				</div>
		</form>
	</div>
