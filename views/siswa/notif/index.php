    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Pendaftaran Tempat KPSI</h5>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-4">
                                    ...
                                    <input class="form-control form-control-alternative" placeholder=" Nim" type="number" name="nim" data-toggle="popover" data-placement="top" data-content="Isi sesuai dengan nim anda" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="input-group input-group-alternative mb-4">
                                        ...
                                        <input class="form-control form-control-alternative" placeholder=" Semester" type="number" name="semester" data-toggle="popover" data-placement="top" data-content="isi semester anda" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="input-group input-group-alternative mb-4">
                                        ...
                                        <input class="form-control form-control-alternative" placeholder=" Nik" type="number" name="nik" data-toggle="popover" data-placement="top" data-content="Isi nik anda" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="input-group input-group-alternative mb-4">
                                        ...
                                        <input class="form-control form-control-alternative" placeholder=" Tools" type="text" name="tools" data-toggle="popover" data-placement="top" data-content="Isin tools yang anda gunakan" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
