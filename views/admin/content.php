            ...
            <div class="card card-stats mb-4 mb-xl-0">
              <div class="card-body">
                <a href="<?php echo base_url('admin/daftarSiswa') ?>">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Daftar Mahasiswa</h5>
                      <?php
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm"><i>Berisi daftar Mahasiswa prakerin</i><br>
            ...
            <div class="card card-stats mb-4 mb-xl-0">
              <div class="card-body">
                <a href="<?php echo base_url('admin/tempatSiswa') ?>">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Daftar Tempat PKL MAHASISWA</h5>
                      <?php
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm"><i>Berisi data-data tempat prakerin mahasiswa</i> <br>
            ...
            <div class="card card-stats mb-4 mb-xl-0">
              <div class="card-body">
                <a href="<?php echo base_url('admin/tempatRekomendasi') ?>">
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm"><i>Berisi daftar tempat rekomendasi mahasiswa</i><br>
            ...
            <div class="card card-stats mb-4 mb-xl-0">
              <div class="card-body">
                <a href="<?php echo base_url('admin/jurusan') ?>">
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm"><i>Untuk mengelola jurusan mahasiswa prakerin</i><br>
            ...
            <div class="card card-stats mb-4 mb-xl-0">
              <div class="card-body">
                <a href="<?php echo base_url('admin/') ?>">
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm"><i>Materi bisa dilihat di berkas</i><br>
                    <!-- <span class="text-success mr-2"><i class="fas fa-arrow-up"></i> 12%</span>
                    <span class="text-nowrap">Since last month</span> -->
                  </p>
                </a>
