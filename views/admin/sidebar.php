      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" id="navv" href="<?php echo base_url('admin/daftarSiswa') ?>">
            <i class="ni ni-single-02"></i> Daftar Mahasiswa
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="navv" href="<?php echo base_url('admin/nilaiSiswa') ?>">
            <i class="ni ni-paper-diploma"></i> Nilai KP Mahasiswa
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="navv" href="<?php echo base_url('admin/jadwalUjian') ?>">
            <i class="ni ni-paper-diploma"></i> Jadwal Ujian
          </a>
        </li>
        <li class="nav-item">
          <?php
        ...
        <li class="nav-item">
          <a class="nav-link" id="navv" href="<?php echo base_url('admin/daftarGuru') ?>">
            <i class="ni ni-circle-08"></i> Daftar Dosen
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="<?php echo base_url('admin/tempatSiswa') ?>">
            <i class="ni ni-building"></i> Tempat Pkl Mahasiswa
          </a>
        </li>
        <li class="nav-item">
