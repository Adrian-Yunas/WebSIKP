                ...
                <div class="col-md-6 ml-4">
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-alternative mb-4">
                            ...
                            <input class="form-control form-control-alternative" placeholder="Cari nama dosen" type="text" name="key">
                        </div>
                    </div>
                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <?php endforeach; ?>
                            <h3 class="mb-0">Daftar Dosen Monitoring <b><?= @$b->jurusan ?></b></h3>
                        </div>
