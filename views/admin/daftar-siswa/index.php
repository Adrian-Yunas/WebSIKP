      ...
      <div class="header-body">
        <form action="<?php echo base_url('admin/daftarSiswa') ?>" method="post">
          <div class="row">
            ...
            <div class="col-md-3">
              <h1 class="display-7 text-white text-uppercase">Tabel Mahasiswa</h1>
            </div>

            <div class="col-md-1 ml--4">
              <a href="<?php echo base_url('admin/tambahSiswa') ?>" class="btn btn-default text-white" type="submit" data-toggle="tooltip" data-placement="top" title="Tambah Mahasiswa">
