        ...
        <div class="table-responsive">
          <div class="card-header border-0">
            ...
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
              ...
              <span class="alert-inner--text"><strong>Peringatan!</strong> Pastikan jurusan sesuai dengan jurusan yang di butuhkan perusahaan!</span>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    if ($rek != "") {
                      ...
                      echo "Bukan Perusahaan Rekomendasi Kuliah";
                    }
                  ...
                  <td>
                    <a href="<?= base_url('admin/taOke/' . $bb) ?>" class="btn-sm btn-success">Iya</a>
