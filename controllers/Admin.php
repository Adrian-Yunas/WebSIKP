...
class Admin extends CI_Controller
{
	...
	public function cus()
	{
		...
		$kepo = array(
			'nama_perusahaan'	=> $perusahaan,
			'pesan'				=> 'Selamat tempat kp anda telah terkonfirmasi!',
			'id_siswa'			=> $id
		);
		...
		$this->db->delete('tb_sementara', $dimana);
		$this->session->set_flashdata('oke', 'Mahasiswa telah di konfirmasi');
		redirect('admin/notif');
	}
	...
	public function absenManual($nim)
	{
		$data['manu']	= $this->db->query("SELECT * FROM tb_tempat_siswa INNER JOIN tb_siswa ON tb_tempat_siswa.id_siswa = tb_siswa.id_siswa WHERE nim = '$nim' ")->result();
		$this->load->view('admin/index');
		$this->load->view('admin/sidebar');
	...
	public function cekManual($nim)
	{
		$siswa				= $this->db->query("SELECT * FROM tb_siswa WHERE nim = '$nim' ")->row();
		$id					= $this->db->query("SELECT * FROM tb_tempat_siswa WHERE id_siswa = '$siswa->id_siswa' ")->row();
		$data['cek']		= $this->db->query("SELECT * FROM tb_tempat_siswa INNER JOIN tb_siswa ON tb_tempat_siswa.id_siswa WHERE nim = '$nim' AND id = '$id->id'  ")->result();
	...
	public function editManual($id)
	{
		...
		$data['diri']		= $this->db->query("SELECT * FROM tb_tempat_siswa INNER JOIN tb_siswa ON tb_tempat_siswa.id_siswa = tb_siswa.id_siswa WHERE nim = '$siswa->nim' ")->result();
	...
	public function addguru()
	{
		...
		$this->session->set_flashdata('tambah_guru', 'Dosen Berhasil di tambah!');
	...
	public function doUpdateguru()
	{
		...
		$this->session->set_flashdata('update_guru', 'Data dosen berhasil di update!');
		redirect('admin/daftarguru');
	}
	...
	public function deleteguru($id)
	{
		...
		$this->session->set_flashdata('delete_guru', 'Data dosen telah terhapus!');
		redirect('admin/daftarguru');
	}
	...
	{
		$data['data']				= $this->db->query("SELECT * FROM tb_tempat_siswa INNER JOIN tb_siswa ON tb_tempat_siswa.id_siswa = tb_siswa.id_siswa WHERE nim = '$nim' ")->result();
	...
	public function tambahNilai()
	{
		...
		$inimiatif		= $this->input->post('inimiatif');
	...
	public function editNilai($id)
	{
		...
		$this->form_validation->set_rules('inimiatif', 'Inimiatif', 'required');
	...
	{
		$data['jadwal'] = $this->m_admin->tampil_data()->result();
		$this->load->view('admin/jadwal/index', $data);
	}

	public function formInput()
	{
		$this->load->view('admin/jadwal/form_input');
	}

	public function formEdit($id)
	{
		$recordJdwl = $this->m_admin->getDataJadwalDetail($id);

		$DATA = array('data_jdwl' => $recordJdwl);
	...
	public function AksiInsert()
	{
		$nama = $this->input->post('nama');
		$jurusan = $this->input->post('jurusan');
		$jadwalujian = $this->input->post('jadwal_ujian');
		$ruangan = $this->input->post('ruangan');
		$dosenpenguji = $this->input->post('dosen_penguji');
		...
		$this->m_admin->InsertDataJdwl($DataInsert);
		redirect(base_url('admin/jadwalUjian'));
	}
	...
	public function AksiEdit()
	{
		...
		$this->m_admin->EditDataJdwl($DataUpdate, $nama);
		redirect(base_url('admin/jadwalUjian'));
	}


	public function AksiDeleteData($nama)
	{
		$this->m_admin->DeleteDataJdwl($nama);
		redirect(base_url('admin/jadwalUjian'));
	}
}
