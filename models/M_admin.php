...
class m_admin extends CI_Model
{
	...
	//Start Function Jadwal Ujian
	public function tampil_data()
	{
		return $this->db->get('tb_jadwal_ujian');
	}

	public function InsertDataJdwl($data)
	{
		$this->db->insert('tb_jadwal_ujian', $data);
	}

	public function EditDataJdwl($data, $id)
	{
		$this->db->where('nama', $id);
		$this->db->update('tb_jadwal_ujian', $data);
	}

	public function getDataJadwalDetail($id)
	{
		$this->db->where('nama', $id);
		$query = $this->db->get('tb_jadwal_ujian');
		return $query->row();
	}

	public function DeleteDataJdwl($id)
	{
		$this->db->where('nama', $id);
	...
	// START FUNCTION TEMPAT KP MAHASISWA 
